	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"iframe",
					{ height: "60", width: "468", frameborder: "0", marginheight: "0", marginwidth: "0", scrolling: "no", allowtransparency: "true", src: "http://img.xrea.com/ad_iframe.fcg?site=glanz.s602.xrea.com" },
					React.createElement(
						"a",
						{ href: "http://img.xrea.com/ad_click.fcg?site=glanz.s602.xrea.com", target: "_blank" },
						React.createElement("img", { src: "http://img.xrea.com/ad_img.fcg?site=glanz.s602.xrea.com", border: "0", alt: "xreaad" })
					)
				)
			)
		);
