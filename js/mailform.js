...
var MailForm = React.createClass({
	...
	render: function render() {
		...
		var reconnectLink = this.props.model.get("tokenGotten") ? null : React.createElement(
			"a",
		...
		var statusBar = this.props.model.get("textStatus") ? React.createElement(
			"p",
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement("input", { value: this.props.model.get("address"), onChange: this.setAddress })
				),
				React.createElement(
					"label",
					null,
